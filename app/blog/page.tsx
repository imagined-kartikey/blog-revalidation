  ...
  return (
    <div className="posts-section container">
      <header className="section-header">
        ...
        <span className="section-count">{posts.length} {posts.length === 1 ? 'post' : 'posts'}</span>
      </header>
      ...
      {posts.length === 0 ? (
        <div className="empty-state">
          ...
          <p className="empty-state__sub">Create your first post in Ghost to see it here.</p>
        </div>
      ) : (
            ...
            <Link key={post.id} href={`/blog/${post.slug}`} className="post-card">
              <div className="post-card__image">
                {post.feature_image ? (
                  ...
                  <img src={post.feature_image} alt={post.feature_image_alt || post.title} loading="lazy" />
                ) : (
              ...
              <div className="post-card__body">
                ...
                <div className="post-card__meta">
                  ...
                  <span className="post-card__read-time">{post.reading_time} min read</span>
                </div>
              </div>
            </Link>
          ))}
